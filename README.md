...
### damier.pdf ###
Ce fichier permet d'imprimer les parties d'un damier qui servira pour des exercices.
### circuit.pdf ###
Ce fichier permet d'imprimer les parties d'un circuit qui servira pour des exercices